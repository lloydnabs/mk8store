...
void Menu::display()
{
	...
	{
		console->drawString(9, 21, "Mario Kart 8 Mod Store");
		console->drawColorString(9, 26, "thanks to:", 0xcc, 0xcc, 0xcc);
		console->drawColorString(15, 27, "vgmoose, pwsincd, rw-r-r_0644, zarklord, Lloyd Nabbit", 0xcc, 0xcc, 0xcc);
	...
	if (this->screen == LIST_MENU || this->screen == INSTALL_SCREEN)
	{
		...
		console->drawColorString(80 / 2 - 15, 0, "Mario Kart 8 Mod Store", 0, 0, 0);
